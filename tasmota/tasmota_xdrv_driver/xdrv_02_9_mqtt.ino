...
#ifdef USE_MQTT_THINGSBOARD_IOT
...
#endif // USE_MQTT_THINGSBOARD_IOT

#if !defined(USE_MQTT_AZURE_IOT) && !defined(USE_MQTT_THINGSBOARD_IOT)
...
//  AddLog(LOG_LEVEL_DEBUG, PSTR(D_LOG_MQTT "BufferSize %d, Topic |%s|, Length %d, data_len %d"), MqttClient.getBufferSize(), mqtt_topic, strlen(mqtt_topic), data_len);
  ...
  #ifdef USE_MQTT_THINGSBOARD_IOT // Send response for RPC method
